  ...
  return (
    <main className="selah-aurora selah-scroll min-h-dvh overflow-y-auto pb-12">
      ...
      <div className="mx-auto max-w-xl px-5 pt-6">
        {!supported && (
          <div className="mb-5 rounded-2xl border border-amber-300/20 bg-amber-300/[0.05] px-4 py-3 text-[13px] text-amber-100">
            <div className="flex items-start gap-2">
              <AlertTriangle className="mt-0.5 h-4 w-4 shrink-0 text-amber-200" />
              <p>{fs.reminderUnsupported}</p>
            </div>
          </div>
        )}
        ...
        {loading ? (
          ...
          <>
            ...
            {perm === "denied" && (
              <div className="mt-4 rounded-xl border border-amber-300/15 bg-amber-300/[0.04] px-4 py-3 text-[12px] text-amber-100/80">
                {fs.reminderPermissionDenied}
              </div>
            )}
          </>
